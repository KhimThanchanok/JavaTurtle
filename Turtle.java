...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener,
    ...
    public static void main(String[] a) {
        ...
        // // SCALE POINT FOR DRWAING
        // Turtle bobDot = new Turtle();
        // bobDot.penColor("red");
        // bobDot.width(10);
        // bobDot.speed(5);
        ...
        // PAINTING BEAR COLOR (Panda)
        Turtle bobColorPanda = new Turtle();
        Color panGrey = new Color(171, 171, 171);
        bobColorPanda.penColor(panGrey);
        // PANDA BODY
        bobColorPanda.width(100);
        bobColorPanda.speed(5);
        bobColorPanda.up();
        bobColorPanda.setPosition(725, 50);
        bobColorPanda.down();
        bobColorPanda.forward(700);
        // PANDA EYES
        bobColorPanda.up();
        bobColorPanda.width(150);
        bobColorPanda.setPosition(1020, 470);
        bobColorPanda.down();
        bobColorPanda.forward(1);
        bobColorPanda.up();
        bobColorPanda.setPosition(1200, 470);
        bobColorPanda.down();
        bobColorPanda.forward(1);
        // PANDA EARS
        bobColorPanda.up();
        bobColorPanda.width(110);
        bobColorPanda.setPosition(900, 700);
        bobColorPanda.down();
        bobColorPanda.forward(1);
        bobColorPanda.up();
        bobColorPanda.width(160);
        bobColorPanda.setPosition(1430, 660);
        bobColorPanda.down();
        bobColorPanda.forward(1);

        // PAINTING BEAR COLOR (Grizz)
        Turtle bobColorGriz = new Turtle();
        int distanceBody = 0;
        Color grizBrown = new Color(133, 86, 47);
        bobColorGriz.penColor(grizBrown);
        bobColorGriz.width(20);
        bobColorGriz.speed(5);
        bobColorGriz.up();
        bobColorGriz.setPosition(1400, 10);
        bobColorGriz.down();
        bobColorGriz.forward(925);
        for (int i = 0; i < 75; i++) {
            if (i % 2 == 0) {
                bobColorGriz.left(90);
                bobColorGriz.forward(10);
                bobColorGriz.left(90);
                bobColorGriz.forward(925 + distanceBody);
            } else {
                bobColorGriz.right(90);
                bobColorGriz.forward(10);
                bobColorGriz.right(90);
                bobColorGriz.forward(925 + distanceBody);
            }
            ...
            if (i > 0 && i <= 35) {
                distanceBody = distanceBody - 2;
            } else if (i > 35 && i <= 40) {
                distanceBody = distanceBody - 4;
            } else if (i > 40 && i <= 50) {
                distanceBody = distanceBody - 10;
            } else if (i > 50 && i <= 62) {
                distanceBody = distanceBody - 15;
            } else if (i > 62 && i <= 66) {
                distanceBody = distanceBody + 12;
            } else if (i > 66 && i <= 72) {
                distanceBody = distanceBody - 15;
            } else if (i > 72 && i <= 75) {
                distanceBody = distanceBody - 30;
            }

        }

        // BODY BEAR's PART
        int distanceBear = 700;
        int dotLine1 = 50;
        int dotLine2 = 50;
        Turtle bobBear = new Turtle();
        bobBear.penColor("black");
        bobBear.width(10);
        bobBear.speed(3);
        ...
        for (int i = 0; i < 3; i++) {
            bobBear.forward(dotLine1);
            bobBear.up();
            bobBear.forward(30);
            bobBear.down();
            dotLine1 = dotLine1 - 20;
        }
        ...
        for (int j = 0; j < 3; j++) {
            ...
            bobBear.home();
            bobBear.down();
            bobBear.forward(distanceBear);
            distanceBear = distanceBear + 700;
        }

        // FINISH LINE
        bobBear.forward(250);
        for (int i = 0; i < 3; i++) {
            bobBear.forward(dotLine2);
            bobBear.up();
            bobBear.forward(30);
            bobBear.down();
            dotLine2 = dotLine2 - 20;
        }

        Turtle bobFace = new Turtle();
        int shiftFaceX = 0, shiftFaceY = 0;
        for (int k = 0; k < 3; k++) {
            // BEAR's FACE
            bobFace.penColor("black");
            bobFace.width(10);
            bobFace.speed(10);
            bobFace.up();

            // BEAR's MOUTH
            bobFace.setPosition(350 + shiftFaceX, 250 + shiftFaceY);
            bobFace.down();
            bobFace.right(90);
            for (int j = 0; j < 2; j++) {
                bobFace.forward(25);
            ...
            bobFace.right(120);
            bobFace.up();
            bobFace.setPosition(280 + shiftFaceX, 270 + shiftFaceY);
            bobFace.down();
            for (int i = 0; i < 5; i++) {
                bobFace.forward(25);
                bobFace.right(20);
            ...
            bobFace.left(60);
            bobFace.up();
            bobFace.setPosition(300 + shiftFaceX, 520 + shiftFaceY);
            bobFace.width(35);
            for (int j = 0; j < 2; j++) {
                bobFace.down();
                for (int i = 0; i < 25; i++) {
                ...
                bobFace.up();
                bobFace.setPosition(470 + shiftFaceX, 520 + shiftFaceY);
            }

            // BEAR's NOSE2
            bobFace.up();
            bobFace.setPosition(360 + shiftFaceX, 425 + shiftFaceY);
            bobFace.width(35);
            bobFace.left(68);
            bobFace.down();
            for (int j = 0; j < 2; j++) {
